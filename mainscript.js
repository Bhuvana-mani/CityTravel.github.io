...
const places=document.getElementById("attractions");
...
const  ctapi={clientId : "4BW4Z1VVYDITXLBFWAOJCD5H1BI310NT3UFAAYS5GMZWQTTQ",
clientSecret :"GR22135U0U2JE3SHAKSNGXLZJKPBEXK4MNH2KWGVO3F4BFEI",
...
function eventListeners() {
  ...
  function displayForecast(forecast) {
    ...
    function getPlaceResults(query) {
      fetch(`${ctapi.base_url}&near=${city}&limit=10&client_id=${clientId}&client_secret=${clientSecret}&v=20180101}`)
        .then((spots) => {
          return spots.json();
        })
        .then(displayplaces);
